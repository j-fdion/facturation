                ...
                <v-container grid-list-md>
                    <v-form v-model="valid" ref="form" lazy-validation>
                        <v-layout wrap>
                            ...
                            <v-flex xs6>
                                <v-text-field label="Coût à l'unité" suffix="$" :rules="priceRules" required v-model="coutUnite"></v-text-field>
                            </v-flex>
                        </v-layout>
                    </v-form>
                </v-container>
...
<script>
    ...
    const { mapState, mapActions, mapGetters, mapMutations } = createNamespacedHelpers('fraisSupplementaire')

    import * as module from '../../store/modules/fraisSupplementaire/fraisSupplementaire'
    ...
    export default {
        ...
        computed: {
            ...
            dialog: {
                get() {
                    return this.$store.state.fraisSupplementaire.dialog;
                },
                set(value) {
            ...
            deleteDialog: {
                get() {
                    return this.$store.state.fraisSupplementaire.deleteDialog;
                },
                set(value) {
            ...
            nom: {
                get() {
                    return this.$store.state.fraisSupplementaire.editedItem.nom;
                },
                set(value) {
            ...
            coutUnite: {
                get() {
                    return this.$store.state.fraisSupplementaire.editedItem.coutUnite;
                },
                set(value) {
                    this.MERGE_EDIT_TO_ITEM({ payload: { coutUnite: value } });
                }
            },
