<template>
    <div>
        ...
        <v-card>
            <v-card-title>
                <v-btn color="primary" dark @click.native.stop="defaultEditItem">Nouveau contact</v-btn>
                <v-spacer></v-spacer>
            ...
            <v-data-table :headers="headers"
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="text-xs-center">{{ props.item.noTelephone1 }}</td>
    ...
    export default {
        data: () => ({
            headers: [
                ...
                { text: 'Numéro de téléphone', align: 'center', value: 'NoTelephone1' },
