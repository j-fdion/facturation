<template>
    <div>
        ...
        <v-card>
            <v-card-title>
                <v-btn color="primary" dark @click.native.stop="defaultEditItem">Nouvel accessoire</v-btn>
                <v-spacer></v-spacer>
            ...
            <v-data-table :headers="headers"
                ...
                <template slot="items" slot-scope="props">
                    <td class="text-xs-center">{{ props.item.modele }}</td>
                    <td class="text-xs-center">{{ props.item.prix }}</td>
                    <td class="text-xs-center">{{ props.item.typeAccessoire.nom }}</td>
...
<script>
    ...
    export default {
        data: () => ({
            headers: [
                { text: 'Modèle', align: 'center', value: 'Modele' },
                { text: 'Prix', align: 'center', value: 'Prix' },
                { text: 'TypeAccessoire', align: 'center', value: 'TypeAccessoire.Nom' },
