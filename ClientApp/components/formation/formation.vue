<template>
    <div>
        ...
        <v-card>
            <v-card-title>
                <v-btn color="primary" dark @click.native.stop="defaultEditItem">Nouvelle formation</v-btn>
                <v-spacer></v-spacer>
            ...
            <v-data-table :headers="headers"
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="text-xs-center">{{ props.item.tauxHoraire }}</td>
                    <td class="text-xs-center">{{ props.item.prixForfaitaire }}</td>
                    <td class="text-xs-center">{{ props.item.prixUnitaire }}</td>
    ...
    export default {
        data: () => ({
            headers: [
                ...
                { text: 'Taux Horaire', align: 'center', value: 'TauxHoraire' },
                { text: 'Prix Forfaitaire', align: 'center', value: 'PrixForfaitaire' },
                { text: 'Prix Unitaire', align: 'center', value: 'PrixUnitaire' },
