<template>
    <div>
        ...
        <v-card>
            <v-card-title>
                <v-btn color="primary" dark @click.native.stop="defaultEditItem">Nouvelle personne</v-btn>
                <v-spacer></v-spacer>
            ...
            <v-data-table :headers="headers"
                ...
                <template slot="items" slot-scope="props">
                    <td class="text-xs-center">{{ props.item.nomComplet }}</td>
                    <td class="text-xs-center">{{ props.item.dateNaissance | formatDateL }}</td>
    ...
    export default {
        data: () => ({
            headers: [
                ...
                { text: 'Date de naissance', align: 'center', value: 'DateNaissance' },
                { text: 'Entreprise', align: 'center', value: 'Entreprise.Nom' },
