...
const load_items_url = '/api/Gestion/FraisSupplementaireSessions'
const save_item_url = '/api/Gestion/SaveFraisSupplementaireSession'
const delete_item_url = '/api/Gestion/DeleteFraisSupplementaireSession'
export const MERGE_EDIT_TO_ITEM = 'MERGE_EDIT_TO_ITEM'

export const fraisSupplementaires = 'fraisSupplementaires'
export const SEARCH_FRAIS_SUPPLEMENTAIRES = 'SEARCH_FRAIS_SUPPLEMENTAIRES'
export const SET_FRAIS_SUPPLEMENTAIRES = 'SET_FRAIS_SUPPLEMENTAIRES'
...
const state = {
    ...
    editedItem: {
        ...
        fraisSupplementaireId: '00000000-0000-0000-0000-000000000000',
        quantite: 0.0,
        absence: false,
...
const mutations = {
    ...
    SET_EDITED_ITEM: (state, { payload }) => {
        ...
        state.fraisSupplementaires = [state.editedItem.fraisSupplementaire]
    },
    SET_EDITED_ITEM_DEFAULT: (state) => {
        state.editedIndex = -1
        state.editedItem = Object.assign({}, state.defaultItem);
        state.fraisSupplementaires = []
    },
    SET_FRAIS_SUPPLEMENTAIRES: (state, { payload }) => {
        state.fraisSupplementaires = payload
    },
...
const actions = ({
    ...
    SEARCH_FRAIS_SUPPLEMENTAIRES: function ({ commit }, { searchTerm }) {
        axios.get('/api/Gestion/SearchFraisSupplementaires', {
            params: {
                searchTerm
            }
        }).then(function (response) {
            commit(SET_FRAIS_SUPPLEMENTAIRES, { payload: response.data });
        }, (err) => {
            console.log(err)
        })
    }
