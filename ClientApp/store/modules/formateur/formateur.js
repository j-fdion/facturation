...
const load_items_url = '/api/Gestion/Formateurs'
const save_item_url = '/api/Gestion/SaveFormateur'
const delete_item_url = '/api/Gestion/DeleteFormateur'
...
const mutations = {
    ...
    SET_EDITED_ITEM: (state, { payload }) => {
        ...
        state.searchedFormations.push(...state.editedItem.formateurFormations)
    },
...
const actions = ({
    ...
    SEARCH_FORMATIONS: function ({ commit }, { searchTerm }) {
        axios.get('/api/Gestion/SearchFormateurFormations', {
            params: {
                searchTerm
            }
        }).then(function (response) {
