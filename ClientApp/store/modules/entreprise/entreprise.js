...
const load_items_url = '/api/Gestion/Entreprises'
const save_item_url = '/api/Gestion/SaveEntreprise'
const delete_item_url = '/api/Gestion/DeleteEntreprise'
...
const mutations = {
    ...
    SET_EDITED_ITEM: (state, { payload }) => {
        ...
        state.searchedContacts.push(...state.editedItem.contactEntreprises)
    },
...
const actions = ({
    ...
    SEARCH_CONTACTS: function ({ commit }, { searchTerm }) {
        axios.get('/api/Gestion/SearchContacts', {
            params: {
                searchTerm
            }
        }).then(function (response) {
